...
!function(i){i(function(){i("#rating").barrating({theme:"css-stars",showSelectedRating:!1}),i(".product__share-link").on("click",function(s){s.preventDefault(),i(this).closest(".product__share").find(".product__share-list").fadeToggle()}),i(".product__share-close").on("click",function(s){s.preventDefault(),i(this).closest(".product__share").find(".product__share-list").fadeOut(),console.log("ddd")});var s=i(".similar-product__row"),t={dots:!1,arrows:!0};!function(s,t){i(window).on("load resize",function(){return i(window).width()>767?void(s.hasClass("slick-initialized")&&s.slick("unslick")):s.hasClass("slick-initialized")?void 0:s.slick(t)})}(s,t)})}(jQuery);